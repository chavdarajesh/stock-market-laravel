            ...
            foreach ($request->setting as $key => $fieldValue) {
                ...
                foreach ($fieldValue as $field => $value) {
                    ...
                    if ($field == 'header_logo') {
                        ...
                        if ($request->old_home_ads_banner && file_exists(public_path($request->old_home_ads_banner))) {
                            unlink(public_path($request->old_home_ads_banner));
                        }
                    } else {
                        if ($value) {
