...
<head>
    ...
    <title>New Career Enquiry | {{ env('APP_NAME', 'Laravel App') }} </title>
</head>
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    <tr>
                                                                        <td align="left"
                                                                            ...
                                                                            Hello,<br>
                                                                            <br>
                                                                            New Career Enquiry Submited With Below
                                                                            Details.<br><br>
                                                                            <br>
                                                                            <br>
                                                                            <p>Name: {{ $data['name'] }}</p>
                                                                            ...
                                                                            <p>Enquiry Date:
                                                                                {{ $data['created_at'] }}</p>
                                                                                <p>Please Note : The attachment file is attached to this email. </p>
                                                                            <br><br>
                                                                            <div
                                                                                style="text-align: center; margin-top: 15px">
                                                                                <a href="{{ route('admin.career.messages.view', $data['id']) }}"
