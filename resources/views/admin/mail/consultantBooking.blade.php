                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    <tr>
                                                                        <td align="left"
                                                                            ...
                                                                            Hello<br>
                                                                            <br>
                                                                            You are receiving this email because you have booke a Consultant.<br><br>
                                                                            So Please join meeting on Date {{$data['date']}} and Time Slot {{ \Carbon\Carbon::parse($data['time_start'])->format('H:i') . ' to ' . \Carbon\Carbon::parse($data['time_end'])->format('H:i') }}.<br><br>
                                                                            <div
